export const NODE_DEFINITIONS = {
    ...
    aiAgent: { category: 'AI & ML', label: 'AI Agent', icon: 'Workflow', color: '#7c3aed', fields: [
        // --- LLM Section ---
